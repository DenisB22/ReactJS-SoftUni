    ...
    <div className="row me-row content-ct speaker" id="speakers">
      ...
      <div className="col-md-4 col-sm-6 feature">
        ...
        <p>
          ...
          variety of situations htmlFor bands, record labels, governments, polar
      ...
      <div className="col-md-4 col-sm-6 feature">
        ...
        <p>
          Stephie is a user experience researcher and designer. In over 15 years
          of working on the web, she has worn many hats, including a product
          lead htmlFor a tech startup in publishing...
        </p>
        <ul className="speaker-social">
          <li>
            <a href="#">
      ...
      <div className="col-md-4 col-sm-6 feature">
        ...
        <p>
          ...
          Developer htmlFor Sky. He Tweets at...
        </p>
        <ul className="speaker-social">
          <li>
            <a href="#">
